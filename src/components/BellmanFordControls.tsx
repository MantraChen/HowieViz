...
export function BellmanFordControls() {
  const { nodes, isAnimating, speed, startNode, setSpeed, setStartNode, run, reset } = useBellmanFordStore()
  ...
  return (
    <div className="space-y-5">
      <div className="space-y-2">
        <label className="text-xs font-medium text-[#a78bde] uppercase tracking-[0.06em]">Bellman-Ford</label>
        <div className="space-y-2">
