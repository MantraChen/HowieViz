...
export function QueueControls({ mode: _mode }: { mode?: string }) {
  const { elements, inputValue, speed, setInputValue, setSpeed, enqueue, dequeue, peek, clear, reset, loadCustom } =
    useQueueStore()
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        <ActionButton onClick={() => hasValidValue && !isFull && enqueue(parsedValue)} disabled={!hasValidValue || isFull} variant="primary">
          Enqueue
        </ActionButton>
