...
export function StackControls({ mode: _mode }: { mode?: string }) {
  const { elements, inputValue, speed, setInputValue, setSpeed, push, pop, peek, clear, reset, loadCustom } =
    useStackStore()
    ...
    <div className="space-y-4">
      ...
      {inputMode === 'custom' && (
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-[#3d2d5a]">Comma-separated integers (bottom to top)</p>
        </div>
      )}
