...
export function TriePage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Trie</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Prefix tree for storing strings. Each path from root to a marked node spells a word.
          Nodes with a filled dot are end-of-word markers. Default words: apple, app, apply, apt, bat, ball.
          <span className="italic"> m = word length.</span>
        </p>
      </div>
