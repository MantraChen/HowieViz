...
export function DoublyLinkedListPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Doubly Linked List</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Each node holds a value plus two pointers — next (→) and prev (←).
          Bidirectional arrows show both connections, enabling O(1) insert and delete at both ends.
        </p>
      </div>
