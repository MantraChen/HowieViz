...
export function HeapSortPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Heap Sort</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Two-phase sort: first build a max-heap in O(n), then repeatedly extract the maximum
          and restore the heap property. Phase labels and pivot highlighting guide each step.
        </p>
      </div>
