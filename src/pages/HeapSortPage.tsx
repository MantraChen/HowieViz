...
const PSEUDOCODE_LINES = [
  ...
  '  if largest != i: swap; siftDown(largest, n)',
]
...
function PseudocodePanel() {
  const currentLine = useHeapSortStore(s => s.currentLine ?? 0)
    ...
    <div className="h-full flex flex-col bg-[#090710]">
      <div className="flex-none flex items-center justify-between px-5 h-14 border-b border-[#2a1f3d] bg-[#0f0b17]">
        <div className="flex flex-col justify-center">
          <h1 className="text-base font-bold text-[#f0eaf8] leading-tight">Heap Sort</h1>
          <p className="text-[11px] text-[#6b4d8a] leading-tight">Max-heap extraction — O(n log n) all cases, O(1) space</p>
        </div>
