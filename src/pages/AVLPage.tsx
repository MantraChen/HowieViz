...
export function AVLPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">AVL Tree</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          A self-balancing BST that maintains O(log n) height. Balance factors (±1 max) are
          shown on each node; rotations animate in red when the tree rebalances after insert or delete.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-[#2a1f3d] bg-[#0f0b17] p-4">
            <p className="text-xs text-[#6b4d8a] leading-relaxed">
              <span className="text-[#b892e8] font-semibold">Rotation types: </span>
              LL → Right, RR → Left, LR → Left-Right, RL → Right-Left
            </p>
          </div>
        </div>
      </div>
