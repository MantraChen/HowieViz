...
export function FenwickPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Fenwick Tree / BIT</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Binary Indexed Tree — a flat array where each cell bit[i] stores the sum of a range determined
          by lowbit(i) = i&amp;(−i). Queries and updates both hop along a chain of O(log n) nodes.
          Default array: [1, 2, 3, 4, 5, 6, 7, 8] (1-indexed for BIT operations).
        </p>
      </div>
