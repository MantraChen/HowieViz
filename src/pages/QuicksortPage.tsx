...
export function QuicksortPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Quicksort</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Divide and conquer: pick a pivot (last element), partition around it, then recurse on each half.
          The pivot lights up in violet; comparisons and swaps animate step by step.
        </p>
      </div>
