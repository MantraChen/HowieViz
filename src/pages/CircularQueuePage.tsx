...
export function CircularQueuePage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Circular Queue</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          A fixed-capacity queue where the rear wraps around to the front, reusing empty slots.
          Front and rear pointers move clockwise as elements enqueue and dequeue.
        </p>
      </div>
