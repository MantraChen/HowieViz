...
export function GraphPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Graph BFS / DFS</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Undirected graph with interactive node positioning. BFS explores level by level; DFS dives as deep
          as possible before backtracking. Tree edges light up as the traversal unfolds.
        </p>
      </div>
