...
const COMPLEXITY_ROWS = [
  { op: "Prim's (binary heap)", time: 'O(E log V)' },
  { op: 'Extract min', time: 'O(log V)' },
  { op: 'Decrease key', time: 'O(log V)' },
  { op: 'Space', time: 'O(V + E)' },
]
...
export function PrimsPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Prim's MST</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Builds a minimum spanning tree by greedily picking the cheapest edge that connects a new
          vertex to the growing MST. Dashed purple lines show the current frontier of candidate edges.
        </p>
      </div>
