...
export function InsertionSortPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#f0eaf8]">Insertion Sort</h1>
        <p className="text-sm text-[#a78bde] mt-1">
          Build the sorted array one element at a time. The current element (violet) slides
          left past larger elements until it reaches its correct position in the sorted portion (purple).
        </p>
      </div>
